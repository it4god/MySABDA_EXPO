...
class Download extends Component {
    ...
    this.setState(
      {
        ...
        is202_1: this.is202_1,
        is202_4: this.is202_4,
        is202_8: this.is202_8,
        is202_10: this.is202_10,

        is203_1: this.is203_1,
        is203_4: this.is203_4,
        is203_8: this.is203_8,
        is203_10: this.is203_10,
            ...
            <List.Section>
              ...
              >
                ...
                <List.Accordion
                  ...
                  expanded={this.state.isitl}
                  onPress={() =>
                    this.setState({ isitl: !this.state.isitl })
                  }
                  style={{
                ...
                >
                  ...
                  >
                    <Switch
                      value={this.state.is202_1}
                      onValueChange={() => {
                        if (this.progressdownload == 0) {
                          this.setState({ is202_1: !this.state.is202_1 });
                          this.IsDownloadOrRemove(this.state.is202_1, "itl_202_1", "itl")
                        }
                        else {
                  ...
                  >
                    <Switch
                      value={this.state.is202_4}
                      onValueChange={() => {
                        if (this.progressdownload == 0) {
                          this.setState({ is202_4: !this.state.is202_4 });
                          this.IsDownloadOrRemove(this.state.is202_4, "itl_202_4", "itl")
                        }
                        else {
                  ...
                  >
                    <Switch
                      value={this.state.is202_8}
                      onValueChange={() => {
                        if (this.progressdownload == 0) {
                          this.setState({ is202_8: !this.state.is202_8 });
                          this.IsDownloadOrRemove(this.state.is202_8, "itl_202_8", "itl")
                        }
                        else {
                  ...
                  >
                    <Switch
                      value={this.state.is202_10}
                      onValueChange={() => {
                        if (this.progressdownload == 0) {
                          this.setState({ is202_10: !this.state.is202_10 });
                          this.IsDownloadOrRemove(this.state.is202_10, "itl_202_10", "itl")
                        }
                        else {
                  ...
                  >
                    <Switch
                      value={this.state.is203_1}
                      onValueChange={() => {
                        if (this.progressdownload == 0) {
                          this.setState({ is203_1: !this.state.is203_1 });
                          this.IsDownloadOrRemove(this.state.is203_1, "itl_203_1", "itl")
                        }
                        else {
                  ...
                  >
                    <Switch
                      value={this.state.is203_4}
                      onValueChange={() => {
                        if (this.progressdownload == 0) {
                          this.setState({ is203_4: !this.state.is203_4 });
                          this.IsDownloadOrRemove(this.state.is203_4, "itl_203_4", "itl")
                        }
                        else {
                  ...
                  >
                    <Switch
                      value={this.state.is203_8}
                      onValueChange={() => {
                        if (this.progressdownload == 0) {
                          this.setState({ is203_8: !this.state.is203_8 });
                          this.IsDownloadOrRemove(this.state.is203_8, "itl_203_8", "itl")
                        }
                        else {
                  ...
                  >
                    <Switch
                      value={this.state.is203_10}
                      onValueChange={() => {
                        if (this.progressdownload == 0) {
                          this.setState({ is203_10: !this.state.is203_10 });
                          this.IsDownloadOrRemove(this.state.is203_10, "itl_203_10", "itl")
                        }
                        else {
  ...
  IsDownloadOrRemove(value, resources, type) {
    ...
    let file_zip = "";
    if (resources == "BibleESV") {
      file_zip = "bibtext_esv_entry.zip"
      map = "bibtext_esv_entry.db"
      type = "bible"
    }

    if (resources == "BibleNET") {
      file_zip = "bibtext_net_entry.zip"
      map = "bibtext_net_entry.db"
      type = "bible"
    }

    if (resources == "BibleAV") {
      file_zip = "bibtext_av_entry.zip"
      map = "bibtext_av_entry.db"
      type = "bible"
    }
    if (resources == "BibleTB") {
      file_zip = "bibtext_tb_entry.zip"
      map = "bibtext_tb_entry.db"
      type = "bible"
    }
    if (resources == "ori_tr") {
      file_zip = "orilang_197.zip"
    ...
    if (resources == "abbott_smith") {
      file_zip = "lexdef_01.zip"
      map = "lexdef_01_map";
      entry = "lexdef_01_entry.json"
      type = "lexicon";
    }
    if (resources == "av_eng") {
      file_zip = "lexdef_02.zip"
      map = "lexdef_02_map";
      entry = "lexdef_02_entry.json"
      type = "lexicon";
    }
    if (resources == "av_ind") {
      file_zip = "lexdef_03.zip"
      map = "lexdef_03_map";
      entry = "lexdef_03_entry.json"
      type = "lexicon";
    }
    if (resources == "barclay") {
      file_zip = "lexdef_04.zip"
      map = "lexdef_04_map";
      entry = "lexdef_04_entry.json"
      type = "lexicon";
    }
    if (resources == "boeker") {
      file_zip = "lexdef_05.zip"
      map = "lexdef_05_map";
      entry = "lexdef_05_entry.json"
      type = "lexicon";
    }
    if (resources == "strong") {
      file_zip = "lexdef_06.zip"
      map = "lexdef_06_map";
    ...
    if (resources == "itl_202_1") {
      file_zip = "itl_202_1_entry.zip"
      map = "itl_202_1_entry.db"
      entry = "itl_202_1_entry.db"
      type = "itl"
    }
    if (resources == "itl_202_4") {
      file_zip = "itl_202_4_entry.zip"
      map = "itl_202_4_entry.db"
      entry = "itl_202_4_entry.db"
      type = "itl"
    }
    if (resources == "itl_202_8") {
      file_zip = "itl_202_81_entry.zip"
      map = "itl_202_8_entry.db"
      entry = "itl_202_8_entry.db"
      type = "itl"
    }
    if (resources == "itl_202_10") {
      file_zip = "itl_202_10_entry.zip"
      map = "itl_202_10_entry.db"
      entry = "itl_202_10_entry.db"
      type = "itl"
    }
    if (resources == "itl_203_1") {
      file_zip = "itl_203_1_entry.zip"
      map = "itl_203_1_entry.db"
      entry = "itl_203_1_entry.db"
      type = "itl"
    }
    if (resources == "itl_203_4") {
      file_zip = "itl_203_4_entry.zip"
      map = "itl_203_4_entry.db"
      entry = "itl_203_4_entry.db"
      type = "itl"
    }
    if (resources == "itl_203_8") {
      file_zip = "itl_203_8_entry.zip"
      map = "itl_203_8_entry.db"
      entry = "itl_203_8_entry.db"
      type = "itl"
    }
    if (resources == "itl_203_10") {
      file_zip = "itl_203_10_entry.zip"
      map = "itl_203_10_entry.db"
      entry = "itl_203_10_entry.db"
      type = "itl"
    }
          ...
          },
          {
            ...
            onPress: () => {
              ...
              if (this.progressdownload2 == 0)
                this.Download(map, entry, file_zip, type)
            },
          },
        ],
        { cancelable: false }
  ...
  async Remove(resources, type) {
    if (type === "lexicon") {
      ...
      if (resources === "BibleESV") {
        ...
        await FileSystem.deleteAsync(sqlDir + "bibtext_esv_entry.db.zip", { idempotent: false });
      }
        ...
        await FileSystem.deleteAsync(sqlDir + "bibtext_net_entry.db.zip", { idempotent: false });
      }
        ...
        await FileSystem.deleteAsync(sqlDir + "bibtext_av_entry.db.zip", { idempotent: false });
      }
        ...
        await FileSystem.deleteAsync(sqlDir + "bibtext_tb_entry.db.zip", { idempotent: false });
      }
      ...
      const sqlDir = FileSystem.documentDirectory + "SQLite/";
      await FileSystem.deleteAsync(sqlDir + resources , { idempotent: false });
  ...
  _storeData = async () => {
    ...
    let is202_1 = "true";
    if (this.state.is202_1 === true) is202_1 = "true";
    else is202_1 = "false"

    let is202_4 = "true";
    if (this.state.is202_4 === true) is202_4 = "true";
    else is202_4 = "false"

    let is202_8 = "true";
    if (this.state.is202_8 === true) is202_8 = "true";
    else is202_8 = "false"

    let is202_10 = "true";
    if (this.state.is202_10 === true) is202_10 = "true";
    else is202_10 = "false"

    let is203_1 = "true";
    if (this.state.is203_1 === true) is203_1 = "true";
    else is203_1 = "false"

    let is203_4 = "true";
    if (this.state.is203_4 === true) is203_4 = "true";
    else is203_4 = "false"

    let is203_8 = "true";
    if (this.state.is203_8 === true) is203_8 = "true";
    else is203_8 = "false"

    let is203_10 = "true";
    if (this.state.is203_10 === true) is203_10 = "true";
    else is203_10 = "false"
    ...
    try {
      await AsyncStorage.setItem("is202_1", is202_1);
    } catch (error) {
      console.log(error);
    }
    try {
      await AsyncStorage.setItem("is202_4", is202_4);
    } catch (error) {
      console.log(error);
    }
    try {
      await AsyncStorage.setItem("is202_8", is202_8);
    } catch (error) {
      console.log(error);
    }
    try {
      await AsyncStorage.setItem("is202_10", is202_10);
    } catch (error) {
      console.log(error);
    }
    try {
      await AsyncStorage.setItem("is203_1", is203_1);
    } catch (error) {
      console.log(error);
    }
    try {
      await AsyncStorage.setItem("is203_4", is203_4);
    } catch (error) {
      console.log(error);
    }
    try {
      await AsyncStorage.setItem("is203_8", is203_8);
    } catch (error) {
      console.log(error);
    }
    try {
      await AsyncStorage.setItem("is203_10", is203_10);
    } catch (error) {
      console.log(error);
    }
    ...
    try {
      await AsyncStorage.setItem("isscofield", isscofield);
    } catch (error) {
      console.log(error);
    }

    try {
      await AsyncStorage.setItem("iscollege", iscollege);
    } catch (error) {
      console.log(error);
    }
  ...
  async DownloadDetail(file_zip) {

  }
  async Download(resources, entry, file_zip, type) {

    console.log(entry + " " + type)

    if (type !== "bible" && type != "itl") {
