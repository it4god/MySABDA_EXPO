...
class EntityinDetailQuestionAnswers extends Component {
      ...
      return (
        ...
        >
          <View style={{ paddingBottom: 20 }}>
            ...
            <View style={{ paddingTop: 25 }}>{this.state.text}</View>
          </View>
  ...
  GoCallAPI() {
    ...
    var urlEntityinDetailQuestionAnswers =
      "https://sabdapro.com:3002/App/app_comment_detail?lang_code=" +
      this.language +
      "&subentry_code=" +
      this.entry_code;

    fetch(urlEntityinDetailQuestionAnswers)
